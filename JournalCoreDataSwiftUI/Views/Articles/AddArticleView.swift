...
struct AddArticleView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            Button(action: {
                if (filtrationDepot) {
                    ...
                    self.selectedDepot=depotController.entries[0]
        ...
        .alert(isPresented: $isShowingAlert) {
            Alert(title: Text("Attention"), message: Text("Merci de saisir un nom, une categorie et un depot pour votre nouvel article."), dismissButton: .default(Text("Ok")))
